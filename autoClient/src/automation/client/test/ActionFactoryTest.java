...
import com.ibm.ie.spm.automation.client.actions.*;
...
//        //String message = "{'action':'com.ibm.ie.spm.automation.client.actions.Wait','data':'5' }";
...
//    }
    ...
    public void testCheck(){
        String message = "{'action':'com.ibm.ie.spm.automation.client.actions.Check','data':'5' }";
    ...
    public void testClick(){
        String message = "{'action':'com.ibm.ie.spm.automation.client.actions.Click','data':'5' }";
    ...
    public void testSelect(){
        String message = "{'action':'com.ibm.ie.spm.automation.client.actions.Select','data':'5' }";
    ...
    public void testVerify(){
        String message = "{'action':'com.ibm.ie.spm.automation.client.actions.Verify','data':'5' }";
    ...
    public void testVerifySummary(){
        String message = "{'action':'com.ibm.ie.spm.automation.client.actions.VerifySummary','data':'5' }";
    ...
    public void testVerifyTable(){
        String message = "{'action':'com.ibm.ie.spm.automation.client.actions.VerifyTable','data':'5' }";
    ...
    public void testGetAll(){
        String message = "{'action':'com.ibm.ie.spm.automation.client.actions.GetAll','data':'5' }";
